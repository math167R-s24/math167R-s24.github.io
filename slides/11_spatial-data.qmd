...
![](images/Screenshot 2024-02-20 at 10.24.44 AM.png)
...
oct19_county_means <- oct19_pm_2_5 |>
  st_set_geometry(NULL) |> # remove the geometry; we don't need it here
  group_by(COUNTY) |>
